            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block">
                        <span class="h3 text-uppercase text-white px-2">Code Lab</span>
                    </a>
                                ...
                                <ul class="dropdown-menu mt-2">
                                    <li class="">
                                        <span class="dropdown-item py-3 px-4" href="#">
                                            <a href="{{ route('user#accountDetails') }}" class="text-decoration-none text-dark"><i class="fa-solid fa-user me-2"></i>Account Detail</a>
                                        </span>
                                    </li>
                                    ...
                                    <li class="">
                                        <span class="dropdown-item py-3 px-4" href="#">
                                            <a href="{{ route('user#changePasswordPage') }}" class="text-decoration-none text-dark"><i class="fa-solid fa-lock me-2"></i>Change Password</a>
                                        </span>
                                    </li>
                                    ...
                                    <li class="my-2 px-2">
                                        <span class="">
                                            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-dark rounded-1 w-100"><i class="fa-solid fa-right-from-bracket mx-1"></i> Logout</button>
                                            </form>
                                        </span>
                                    </li>
                                </ul>
